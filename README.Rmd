...
## Citation
Mangiola et al., (2020). ggmagnolia: an R package for modular heatmap production based on tidy principles. Journal of Open Source Software, 5(52), 2472, https://doi.org/10.21105/joss.02472
...
ggmagnolia::pasilla %>%
	...
	# filter
	filter(symbol %in% head(unique(ggmagnolia::pasilla$symbol), n = 10)) %>%
